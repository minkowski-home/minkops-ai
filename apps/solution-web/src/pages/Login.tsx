...
export default function Login() {
  ...
  return <main className="login-screen">
    <section className="login-story"><div className="login-wordmark"><span className="wordmark-dot" />minkops</div><div><h1>Welcome back</h1><p>Sign in to your operator dashboard. Your fleet has been running while you were away.</p></div><small>tenant_acme · Acme Corp</small></section>
