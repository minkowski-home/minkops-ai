        ...
        <section className="demo-section-container" ref={ref}>
            <div className="demo-content">
                ...
                <div className="features-grid">
                    {[
                        { title: "Real-time Response", desc: "Instant interaction with < 200ms latency." },
                        { title: "Context Aware", desc: "Remembers conversation history across sessions." },
                        { title: "Task Autonomy", desc: "Executes complex workflows without supervision." }
                    ].map((feature, index) => (
                        <motion.div
                            key={index}
